	...
	return func(ctx httpcontract.Context) {
		...
		case *ginpackage.GinContext:
			...
			New(Options{
				...
				AllowedOrigins:      ginpackage.ConfigFacade.Get("cors.allowed_origins").([]string),
				AllowedHeaders:      ginpackage.ConfigFacade.Get("cors.allowed_headers").([]string),
				ExposedHeaders:      ginpackage.ConfigFacade.Get("cors.exposed_headers").([]string),
